...
// 1. Get projectId
const projectId = "f6b66e5531710181d66d05c454bbb721";
...
export default function Home() {
  ...
  const [swiperInstance2, setSwiperInstance2] = useState<SwiperCore | null>(
    null
  );
    ...
    <main className="main-background">
            ...
            <div className="lg:flex flex-wrap items-center justify-between mx-auto p-4">
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-8 items-center">
                  <button
                    onClick={() => open()}
                    className="btn-connect cursor lg:hidden md:block text-sm p-3 lg:px-4 px-4 rounded-2xl font-bold"
                  >
                    Connect Wallet
                  </button>
                  <div
              ...
              <div
                className={`lg:flex  items-center  xl:gap-20 lg:gap-10 gap-4 nav-ul-parent lg:mt-0 mt-4 ${
                  menu == true ? "" : "my_desk"
                }`}
              >
                <div className="w-full md:block md:w-auto" id="navbar-default">
                  <ul className="flex lg:flex-row flex-col lg:gap-20 gap-5  text-black">
                    <li>
                      <a
                        href="#"
                        className="block hover:text-[#489EFF] cursor py-2 px-3 rounded md:bg-transparent  md:p-0 "
                        aria-current="page"
                      >
                        Home
                      </a>
                    ...
                    <li>
                      <a
                        href="#services"
                        className="block py-2 px-3 rounded md:bg-transparent hover:text-[#489EFF] md:p-0"
                        aria-current="page"
                      >
                        Services
                      </a>
                    ...
                    <li>
                      <a
                        href="#faq"
                        className="block cursor py-2 px-3 rounded md:bg-transparent hover:text-[#489EFF] md:p-0"
                        aria-current="page"
                      >
                        Company
                      </a>
                ...
                <div className="flex mb-6 lg:mb-0 ms-3 lg:ms-0 lg:gap-5 lg:mt-0 mt-3 gap-10 flex-wrap items-center">
                  ...
                  <a
                    href="https://t.me/swisscheesegroup"
                    className="cursor"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
                      src="/telegram-blue.png"
                      className="items-center"
                      alt="instagram"
                    />
                ...
                {isConnected ? (
                  <button
                    onClick={() => open()}
                    className="btn-connect cursor button lg:block hidden text-sm p-3 lg:px-4 px-4 rounded-2xl font-bold"
                  >
                    {address}
                  </button>
                ) : (
        ...
        <div className="wrapper relative z-10">
          <div className="flex lg:grid flex-wrap lg:grid-cols-2 lg:py-32 banner-row relative items-center">
            <div className="w-full">
              <h1 className="xl:text-7xl md:text-6xl text-5xl text-[#287AFB] azonix">
                VTS
              </h1>
              <div className="flex items-end mt-3">
                <h1 className="xl:text-7xl md:text-6xl text-5xl text-white text-gradient azonix font-bold">
                  Utility Token
                </h1>
              </div>
              <p className="text-black py-4 text-light-theme text-sm font-normal lg:w-1/3 leading-loose lg:absolute">
                Envision, Empower, Evolve Leading the Revolution through
                Strategic Web3, Mobile and Blockchain Engineering
              </p>
              ...
              <form className="rounded text-center pre_form">
                ...
                <div className="lightblue-grad lg:px-10 px-3 py-2">
                  <div className="equate">
                    1 $VTS = <span className="text-[#287AFB]">$0.10</span>{" "}
                    <span className="text-sm font-bold ml-5">
                      <del>$0.50</del>
                    </span>
                  </div>
                  <div className="flex justify-between items-center mt-lg-2">
                    <span className="block lg:text-sm text-[12px] lg:font-[600] font-[300]">
                ...
                <div className="w-full lg:px-6 px-3">
                  <div className="clock-box flex items-baseline gap-2 justify-between">
                    <div className="flex items-baseline gap-2 px-lg-2 py-3">
                      <span className="lg:text-4xl  text-[30px] azonix font-bold">
                        51
                      </span>{" "}
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="text-black bg-white flex justify-between items-center p-4 w-full rounded-[24px]"
                      type="button"
                    >
                    ...
                    <div
                      id="dropdown"
                      className={`${
                        dropdown == true ? "" : "hidden"
                      } z-10 mt-2 absolute  bg-white divide-y w-full divide-gray-100 rounded-lg shadow  dark:bg-gray-700`}
                    >
                      <ul
                      ...
                      >
                        <li>
                          <a
                            ...
                            className="flex  gap-3 items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="22"
                  ...
                  <div className="py-3 flex gap-4">
                    <div className="text-start w-2/4">
                      <label
                        htmlFor=""
                        className="text-[#5F6F89] mb-2 block font-[600] lg:text-[12px] text-[10px]"
                      >
                        Amount You Pay
                      </label>
                      <input
                        type="text"
                        className="w-full p-4 focus:outline-none rounded-[23px] text-[#273648] text-[14px] font-bold"
                      />
                    </div>
                    <div className="text-start w-2/4">
                      <label
                  ...
                  <button
                    ...
                    className="banner_btn w-full p-4 text-white font-[600] mt-4 text-sm"
                  >
                    Connect Wallet
                  </button>
                  <div className="flex justify-center gap-2 items-center lg:text-sm text-[10px] pt-4">
                    ...
                    <img
                      ...
                      alt="Flowbite Logo"
                    />
                    <span className="text-[#267BF6] font-[600]">
          ...
          <div className="mt-5 flex justify-center items-center relative h-[48px]">
            ...
            >
              <SwiperSlide className="relative">
                <p className="links-light link-under-1 mx-3">
                  protocol development
                </p>
              </SwiperSlide>
              <SwiperSlide className="relative">
                <p className="links-light link-under-2 mx-3">
                  Contact creation
                </p>
              </SwiperSlide>
              <SwiperSlide className="relative">
              ...
              <SwiperSlide className="relative">
                <p className="links-light link-under-4 mx-3">
                  Staking Mechanism
                </p>
              </SwiperSlide>
              <SwiperSlide className="relative">
                <p className="links-light link-under-5 mx-3">
            ...
            <div className="flex grid-cols-2 gap-2" style={{ gap: "0" }}>
              ...
              <div className="my-auto">
                <p className="serv-para mb-8">
                  Shape the future of finance with our cryptocurrency
                  development services. Our area of expertise is developing
                  custom cryptocurrencies that transform the way value is
                  transferred. These digital assets go beyond traditional
                  financial systems, enabling efficient and safe peer-to-peer
                  international transactions.{" "}
                  {Learnmore
                    ? "We re creating currencies that set a new standard for transparency, security, and accessibility on the basis of innovative blockchain technology and cryptographic principles."
                    : ""}
                </p>
                <button
                  className="serv-btn pt-3 ps-10 pb-3 pe-10"
                  onClick={() => {
      ...
      <section id="services" className="lg:hidden block">
        <div className="wrapper pb-10">
          <div className="flex gap-3 items-end justify-center relative">
            <h3 className="exp-grad serv-pos-adj ">Explore our</h3>
            <h1 className="serv-grad mb-0">Services</h1>
          </div>
          <div className="flex justify-center items-center">
            ...
            <div className="flex justify-between items-center relative overflow-hidden w-full px-2 py-5  h-[55px]">
              ...
              >
                ...
                <SwiperSlide className="relative">
                  <p className="links-light link-under-3 mx-3">
                    NFT development
                  </p>
                </SwiperSlide>
                <SwiperSlide className="relative">
          ...
          <div className="px-3">
            <p className="serv-para mb-8 opaque relative">
              Shape the future of finance with our cryptocurrency development
              services. Our area of expertise is developing custom
              cryptocurrencies that transform the way value is transferred.
              These digital assets go beyond traditional financial systems,
              enabling efficient and safe peer-to-peer international
              transactions.Were creating currencies that set a new
            </p>
            <button className="serv-btn pt-3 ps-10 pb-3 pe-10">
              Learn More
            </button>
          </div>
        </div>
          ...
          <div className="relative prior flex flex-col gap-10 py-11 px-16 road_map">
            ...
            <div className="relative">
              <div className="jan-adj">
                <h1 className="month text-[#2B425B] hover:text-[#287AFB] cursor-pointer">
                  Jan 2024
                </h1>
                <p className="month-para">Platform Launch</p>
              </div>
      ...
      <section className="hidden lg:block">
        <footer className="wrapper flex justify-between items-center">
          ...
          <div className="flex justify-between me-20">
            <p className=" me-7 cursor-pointer hover:text-[#2977ff]">
              Privacy Policy
            </p>
            <p className=" me-7 cursor-pointer hover:text-[#2977ff]">
              Terms and consition
          ...
          <span className="text-[#A8A8CF] text-[10px] cursor">
            All rights reserved by VTS 2024
          </span>
        </footer>
      </section>
      {/* for desktop end */}
      ...
      <section className="lg:hidden block">
        <div className="wrapper mt-6">
          <footer className="flex justify-between pt-20 items-center pb-4">
            ...
            <span className="text-[12px] text-[#A8A8CF] cursor">
              All rights reserved by VTS 2024
            </span>
          </footer>
        </div>
